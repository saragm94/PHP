...
try
{
    ...
    $sql = "CREATE TABLE IF NOT EXISTS `countries` (
      ...
      $sql .= "INSERT INTO `teams` (`id`, `full_name`, `abbreviation`, `nickname`, `city`, `state`, `country`, `year_founded`, `modality`, `league`, `logo`) VALUES
      (1, 'Atlanta Dream', 'ATL', 'Dream', 'Atlanta', 'Atlanta', 226, 2007, 'FEM', 1, '../img/teams/Atlanta_Dream_logo.png'),
      (2, 'Chicago Sky', 'SKY', 'Sky', 'Chicago', 'Illinois', 226, 2006, 'FEM', 1, '../img/teams/Chicago_Sky_logo.png'),
      (3, 'Connecticut Sun', 'SUN', 'Sun', 'Uncasville', 'Connecticut', 226, 1999, 'FEM', 1, '../img/teams/Connecticut_Sun_logo.png'),
      (4, 'Indiana Fever', 'FEV', 'Fever', 'Indianapolis', 'Indiana', 226, 2000, 'FEM', 1, '../img/teams/Indiana_Fever_logo.png'),
      (5, 'New York Liberty', 'LIB', 'Liberty', 'Brooklyn', 'New York', 226, 1996, 'FEM', 1, '../img/teams/New_York_Liberty_logo.png'),
      (6, 'Washington Mystics', 'MYS', 'Mystics', 'Washington', 'D.C.', 226, 1998, 'FEM', 1, '../img/teams/Washington_Mystics_logo.png'),
      (7, 'Dallas Wings', 'WIN', 'Wings', 'University of Texas at Arlington Arlington', 'Texas', 226, 1998, 'FEM', 1, '../img/teams/Dallas_Wings_logo.png'),
      (8, 'Las Vegas Aces', 'ACE', 'Aces', 'Paradise', 'Nevada', 226, 1997, 'FEM', 1, '../img/teams/Las_Vegas_Aces_logo.png'),
      (9, 'Los Angeles Sparks', 'SPA', 'Sparks', 'Los Angeles', 'California', 226, 1997, 'FEM', 1, '../img/teams/Los_Angeles_Sparks_logo.png'),
      (10, 'Minnesota Lynx', 'LYN', 'Lynx', 'Minneapolis', 'Minnesota', 226, 1999, 'FEM', 1, '../img/teams/Minnesota_Lynx_logo.png'),
      (11, 'Phoenix Mercury', 'MER', 'Mercury', 'Phoenix', 'Arizona', 226, 1997, 'FEM', 1, '../img/teams/Phoenix_Mercury_logo.png'),
      (12, 'Seattle Storm', 'STO', 'Storm', 'Seattle', 'Washington', 226, 1999, 'FEM', 1, '../img/teams/Seattle_Storm_logo.png');";
      ...
      $sql .= "INSERT INTO `ranking` (`id_team`,`victory`,`lose`,`total_matches`,`percentage`) VALUES
      (1,3,3,6,50.0),
      (2,5,3,8,62.5),
      (3,5,2,7,71.43),
      (4,2,7,9,22.2),
      ...
      //TEAM_IMAGES
      $sql .= "CREATE TABLE IF NOT EXISTS `team_images` (
        `id` int(255) NOT NULL AUTO_INCREMENT,
        `id_team` int(255) NOT NULL,
        `image` varchar(255),
        primary key(`id`),
      ...
      $sql .= "INSERT INTO `team_images` (`id_team`,`image`) VALUES
      (1,'../img/teams_images/1160768554.jpg'),
      (1,'../img/teams_images/atlanta-dream-wnba-black-lives-matter.jpg'),
      (2,'../img/teams_images/1243000420.jpg'),
      ...
      $sql .= "INSERT INTO `matches` (`id_local_team`, `id_visit_team`, `local_points`, `visit_points`, `match_day`) VALUES
      (9,12,68,81,'2022-04-23'),
      (6,1,69,88,'2022-04-24'),
      (7,2,92,77,'2022-04-25'),
      (10,6,66,78,'2022-04-27'),
      (12,11,82,78,'2022-04-28'),
      (2,4,75,79,'2022-04-30'),
      (1,3,78,94,'2022-05-01'),
      (8,10,86,89,'2022-05-01'),
      (4,7,89,101,'2022-05-02'),
      (4,6,70,84,'2022-05-06'),
      (9,2,98,91,'2022-05-06'),
      (8,11,106,88,'2022-05-06'),
      (10,12,74,97,'2022-05-06'),
      (3,5,79,81,'2022-05-07'),
      (1,7,66,59,'2022-05-07'),
      (9,4,87,77,'2022-05-08'),
      (6,10,78,66,'2022-05-08'),
      (12,8,74,85,'2022-05-08'),
      (8,6,76,89,'2022-05-10'),
      (10,4,76,82,'2022-05-10'),
      (9,1,75,77,'2022-05-11'),
      (5,2,50,83,'2022-05-11'),
      (12,11,77,97,'2022-05-11'),
      (7,6,94,86,'2022-05-13'),
      (8,1,96,73,'2022-05-13'),
      (4,5,92,86,'2022-05-13'),
      (11,12,69,64,'2022-05-14'),
      (9,3,60,77,'2022-05-14'),
      (2,10,82,78,'2022-05-14'),
      (7,5,81,71,'2022-05-15'),
      (1,4,85,79,'2022-05-15'),
      (3,5,92,65,'2022-05-17'),
      (1,4,101,79,'2022-05-17'),
      (6,7,84,68,'2022-05-17'),
      (11,8,74,86,'2022-05-17'),
      (10,9,87,84,'2022-05-17'),
      (2,12,71,74,'2022-05-18'),
      (10,8,87,93,'2022-05-19'),
      (7,11,94,84,'2022-05-19'),
      (4,3,85,94,'2022-05-20'),
      (6,1,78,73,'2022-05-20'),
      (9,12,80,83,'2022-05-20'),
      (11,8,80,100,'2022-05-21'),
      (10,7,78,94,'2022-05-21'),
      (3,4,92,70,'2022-05-22'),
      (2,6,82,73,'2022-05-22'),
      (9,8,76,104,'2022-05-23'),
      (7,3,85,77,'2022-05-23'),
      (1,6,50,70,'2022-05-23'),
      (4,2,90,95,'2022-05-23'),
      (5,10,78,84,'2022-05-23'),
      (11,9,94,99,'2022-05-25'),
      (7,3,68,99,'2022-05-26'),
      (9,4,96,101,'2022-05-27'),
      (5,12,71,79,'2022-05-27'),
      (8,2,83,76,'2022-05-28'),
      (6,3,71,79,'2022-05-28'),
      (11,1,54,81,'2022-05-29'),
      (5,12,61,92,'2022-05-29'),
      (9,10,85,83,'2022-05-29'),
      (6,4,87,75,'2022-05-31'),
      (11,2,70,73,'2022-05-31'),
      (3,8,81,89,'2022-05-31'),
      (7,9,91,93,'2022-05-31'),
      (10,1,76,84,'2022-06-01'),
      (4,5,74,87,'2022-06-01'),
      (3,8,97,90,'2022-06-02'),
      (5,6,74,70,'2022-06-03'),
      (2,1,73,65,'2022-06-03'),
      (3,11,92,88,'2022-06-03'),
      (7,12,68,51,'2022-06-03'),
      (10,5,84,77,'2022-06-05'),
      (4,1,66,75,'2022-06-05'),
      (6,2,82,91,'2022-06-05'),
      (7,8,78,84,'2022-06-05'),
      (9,11,74,81,'2022-06-05'),
      (3,12,93,86,'2022-06-05'),
      (4,3,69,88,'2022-06-08'),
      (2,6,82,84,'2022-06-08'),
      (2,3,83,79,'2022-06-10'),
      (12,7,89,88,'2022-06-10'),
      (6,10,76,59,'2022-06-10'),
      (1,11,88,90,'2022-06-10'),
      (8,9,89,72,'2022-06-11'),
      (2,5,88,86,'2022-06-12'),
      (12,7,84,79,'2022-06-12'),
      (11,6,99,90,'2022-06-12'),
      (4,10,84,80,'2022-06-12');";
    ...
    $sql .= "INSERT INTO `users`(`username`,`pass`,`role`) VALUES
    ('admin','8c6976e5b5410415bde908bd4dee15dfb167a9c873fc4bb8a81f6f2ab448a918',1),
    ('sara','17f80754644d33ac685b0842a402229adbb43fc9312f7bdf36ba24237a1f1ffb',2),
    ('jorge','f40d03da338b2c73d41506c9e6fe9603937c910efa04b7160033acc1fb3cf08f',3);";
