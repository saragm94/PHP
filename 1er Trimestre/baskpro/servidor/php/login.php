...
<div class='d-flex aligns-items-center justify-content-center'>
    <table>
        <form method="post" action="login_check.php" name="login_inicio">
            ...
            <tr>
                <th></th>
                <th><button type="submit" name="register" value="register">Enter</button></th>
            </tr>
            </form>
        <form method="post" action="register.php" name="login_inicio">
        <tr>
            <th></th>
            <th><button type="submit" name="register" value="register">Register</button></th>
        </tr>
        </form>
    </table>
</div>
